...
/***/ "./node_modules/css-loader/dist/cjs.js!./libs/custom.css":
/*!***************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./libs/custom.css ***!
  \***************************************************************/
...
`, "",{"version":3,"sources":["webpack://./libs/custom.css"],"names":[],"mappings":"AAAA;IACI,oCAAoC;AACxC","sourcesContent":["body {\n    background-color: rgb(221, 221, 221);\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_custom_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./custom.css */ "./node_modules/css-loader/dist/cjs.js!./libs/custom.css");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LibraryServiceError: () => (/* binding */ LibraryServiceError)
/* harmony export */ });
...
var LibraryServiceError = (function (_super) {
    __extends(LibraryServiceError, _super);
    function LibraryServiceError(message) {
        var _this = _super.call(this, message) || this;
        _this.name = _this.name = _this.constructor.name;
        _this.stack = new Error().stack;
        return _this;
    }
    return LibraryServiceError;
}(Error));
...
var Library = (function () {
    ...
    Library.prototype.addAll = function (items) {
        var _a;
...
var AlertModal = (function () {
    function AlertModal(modalId, titleElementSelector, messageElementSelector, btnPrimaryElementSelector) {
        ...
        this.btnPrimaryElement = this.querySelector(btnPrimaryElementSelector);
        this.modalInstance = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(this.modalElement);
    }
    AlertModal.prototype.show = function (message) {
    ...
    AlertModal.prototype.setContent = function (message) {
        this.messageElement.textContent = message;
    };
    AlertModal.prototype.querySelector = function (selectors) {
        return this.modalElement.querySelector(selectors);
    };
    return AlertModal;
}());

var PromptModal = (function (_super) {
    __extends(PromptModal, _super);
    function PromptModal(modalId, titleElementSelector, messageElementSelector, inputElementSelector, btnPrimaryElementSelector, btnSecondaryElementSelector) {
        var _this = _super.call(this, modalId, messageElementSelector, titleElementSelector, btnPrimaryElementSelector) || this;
        _this.inputElement = _this.querySelector(inputElementSelector);
        _this.btnSecondaryElement = _this.querySelector(btnSecondaryElementSelector);
        return _this;
    }
    PromptModal.prototype.addBtnPrimaryEventListener = function (btnPrimaryListener) {
        this.btnPrimaryElement.addEventListener("click", btnPrimaryListener);
        return this;
    };
    PromptModal.prototype.setBtnPrimaryDataAttribute = function (data, name) {
        this.btnPrimaryElement.setAttribute(name, data);
        return this;
    };
    PromptModal.prototype.getBtnPrimaryDataAttribute = function (name) {
        return this.btnPrimaryElement.getAttribute(name);
    };
    PromptModal.prototype.show = function (message) {
        var _this = this;
        this.clearInput();
        _super.prototype.show.call(this, message);
        return new Promise(function (resolve) {
            ...
            _this.addBtnPrimaryEventListener(confirmHandler);
        });
    };
    PromptModal.prototype.clearInput = function () {
        if (this.inputElement) {
            this.inputElement.value = "";
        }
        return this;
    };
    PromptModal.prototype.getInputValue = function () {
...
var Book = (function () {
    function Book(_a) {
        var id = _a.id, title = _a.title, author = _a.author, year = _a.year, _b = _a.isBorrowed, isBorrowed = _b === void 0 ? false : _b, _c = _a.borrowedBy, borrowedBy = _c === void 0 ? null : _c;
        this.id = id;
        this.title = title;
        this.author = author;
        this.year = year;
    ...
    Book.prototype.borrowBook = function (userId) {
...
var User = (function () {
    function User(_a) {
        var id = _a.id, name = _a.name, email = _a.email, _b = _a.borrowedBooks, borrowedBooks = _b === void 0 ? [] : _b;
        this.id = id;
        this.name = name;
        this.email = email;
...
var LibraryService = (function () {
    function LibraryService(storage) {
        ...
        var storedBooks = this.storage.getItem("books") || [];
        this.books = new _library__WEBPACK_IMPORTED_MODULE_1__.Library(storedBooks.map(function (bookData) { return new _models__WEBPACK_IMPORTED_MODULE_0__.Book(bookData); }));
        var storedUsers = this.storage.getItem("users") || [];
        this.users = new _library__WEBPACK_IMPORTED_MODULE_1__.Library(storedUsers.map(function (userData) { return new _models__WEBPACK_IMPORTED_MODULE_0__.User(userData); }));
    ...
    LibraryService.prototype.borrowBook = function (bookId, userId) {
        ...
        if (user.borrowedBooks.length >= 3) {
            throw new _errors__WEBPACK_IMPORTED_MODULE_2__.LibraryServiceError("Не можна позичити більше, ніж три книги.");
        }
        if (book.isBorrowed) {
            throw new _errors__WEBPACK_IMPORTED_MODULE_2__.LibraryServiceError("Книгу вже позичили.");
        }
    ...
    LibraryService.prototype.returnBook = function (bookId) {
        var book = this.getBookById(bookId);
        if (!book.borrowedBy) {
            throw new _errors__WEBPACK_IMPORTED_MODULE_2__.LibraryServiceError("Книгу не позичали.");
        }
        var user = this.getUserById(book.borrowedBy);
        book.returnBook();
        user.returnBook(book.id);
        this.saveData();
    };
    LibraryService.prototype.getBookById = function (id) {
        var result = this.books.find(function (book) { return book.id === id; });
        if (!result) {
            throw new _errors__WEBPACK_IMPORTED_MODULE_2__.LibraryServiceError("Книгу не знайдено.");
        }
        return result;
    };
    LibraryService.prototype.getUserById = function (id) {
        var result = this.users.find(function (user) { return user.id === id; });
        if (!result) {
            throw new _errors__WEBPACK_IMPORTED_MODULE_2__.LibraryServiceError("Користувача не знайдено.");
        }
        return result;
    };
    LibraryService.prototype.createBook = function (book) {
        var newBook = new _models__WEBPACK_IMPORTED_MODULE_0__.Book(__assign(__assign({}, book), { id: this.bookIdCounter.toString() }));
        this.books.add(newBook);
        this.bookIdCounter++;
        this.saveData();
        return newBook;
    };
    LibraryService.prototype.createUser = function (user) {
        var newUser = new _models__WEBPACK_IMPORTED_MODULE_0__.User(__assign(__assign({}, user), { id: this.userIdCounter.toString() }));
        this.users.add(newUser);
        this.userIdCounter++;
        this.saveData();
        return newUser;
    };
    LibraryService.prototype.clearBooks = function () {
        this.bookIdCounter = 1;
        this.books.clear();
        this.saveData();
    };
    LibraryService.prototype.clearUsers = function () {
        this.userIdCounter = 1;
        this.users.clear();
        this.saveData();
    };
...
var Validation;
(function (Validation) {
    var BookValidator = (function () {
        function BookValidator() {
        }
        BookValidator.validateTitle = function (title) {
            if (!title.trim()) {
                return "Уведіть назву книги";
            }
            return null;
        };
        BookValidator.validateAuthor = function (author) {
            if (!author.trim()) {
                return "Уведіть ім'я автора";
            }
            return null;
        };
        BookValidator.validateYear = function (year) {
            if (!year.trim()) {
            ...
            var yearOfTheFirstBook = -4000;
            if (yearNumber < yearOfTheFirstBook || yearNumber > currentYear) {
                return "\u0420\u0456\u043A \u0432\u0438\u0434\u0430\u043D\u043D\u044F \u043C\u043E\u0436\u0435 \u0431\u0443\u0442\u0438 \u043C\u0456\u0436 ".concat(yearOfTheFirstBook, " \u0456 ").concat(currentYear);
            }
            return null;
        };
        return BookValidator;
    }());
    Validation.BookValidator = BookValidator;
    var UserValidator = (function () {
        function UserValidator() {
        }
        UserValidator.validateName = function (name) {
            if (!name.trim()) {
        ...
        UserValidator.validateUserId = function (id) {
            if (!id.trim()) {
...
/* harmony import */ var _libs_custom_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../libs/custom.css */ "./libs/custom.css");
...
var App = (function () {
    ...
    App.prototype.showValidationErrors = function (errors) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4, this.promptModal.show("Введіть ID користувача, який позичає книгу:")];
                    case 1:
                        userId = _a.sent();
                        return [4, this.confirmBorrowBook(bookId, userId)];
                    case 2:
                        _a.sent();
                        return [3, 4];
                    case 3:
                        error_1 = _a.sent();
                        this.alertModal.show(error_1.message);
                        return [3, 4];
                    case 4: return [2];
                }
            });
    ...
    App.prototype.confirmBorrowBook = function (bookId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var book, user;
            return __generator(this, function (_a) {
                try {
                ...
                this.alertModal.show("".concat(book.title, " \u043F\u043E\u0437\u0438\u0447\u0438\u0432 \u043A\u043E\u0440\u0438\u0441\u0442\u0443\u0432\u0430\u0447 ").concat(user.name, "."));
                this.renderBooks();
                return [2];
            });
        });
    };
    App.prototype.returnBook = function (bookId) {
        var book;
        try {
            book = this.library.getBookById(bookId);
        ...
        this.alertModal.show("".concat(book.title, " \u043F\u043E\u0432\u0435\u0440\u043D\u0435\u043D\u043E."));
        this.renderBooks();
    };
    ...
    App.prototype.clearBooks = function () {
